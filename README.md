This [userscript](https://www.tampermonkey.net/) is intented to retrieve the full CSS/Xpath path of a selected node or a provided text as argument in your browser Dev Tools.
